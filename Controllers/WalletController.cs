...
namespace wepay.Controllers
{
    ...
    public class WalletController : ControllerBase
    {
        ...
        public async Task<IActionResult> TransferMoneyWithinWallet([FromBody] TransferWithinWalletDto transferWithinWalletDto)
        {
            ...
            var currencyFrom = await _serviceManager.WalletService.GetCurrencyByShortCodeForAWallet(wallet.Address, transferWithinWalletDto.CurrencyFromShortCode);
            var currentyTo = await _serviceManager.OtpService.GetCurrencyByShortCodeForAWallet(wallet.Address, transferWithinWalletDto.CurrencyToShortCode);
