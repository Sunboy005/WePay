        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WalletCurrencies_Currencies_CurrencyId",
                        column: x => x.CurrencyId,
                        principalTable: "Currencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WalletCurrencies_Wallets_WalletId",
                        column: x => x.WalletId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    WalletCurrencyId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_WalletCurrencies_WalletCurrencyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WalletCurrencies_CurrencyId",
                table: "WalletCurrencies",
                column: "CurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_WalletCurrencies_WalletId",
                table: "WalletCurrencies",
                column: "WalletId");
